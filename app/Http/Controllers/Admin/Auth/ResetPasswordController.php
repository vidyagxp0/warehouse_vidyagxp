...
class ResetPasswordController extends Controller
{
    ...
    public function showResetForm($token)
    {
        ...
        $resetToken = AdminPasswordReset::where('token', $token)->where('status', Status::ENABLE)->where('email',session()->get('pass_res_mail'))->latest('id')->first();

        if (!$resetToken) {
            $notify[] = ['error', 'Verification code mismatchhhhhhhh'];
