<div class="sidebar bg--dark">
    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            ...
            <img src="<?php echo e(getImage(getFilePath('logoIcon') . '/symbiotec.jpeg')); ?>" alt="<?php echo app('translator')->get('image'); ?>"
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            ...
            if($hasPermission == 1): ?>
                ...
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.avl*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.AVL.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.index')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('AVL'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.product_planning*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.product_planning.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.product_planning')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Production Planning'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.receiving*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.receiving.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.receiving')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Receiving'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.storage*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.storage.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.storage')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Storage'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.storage_condition*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.storage_condition.*')); ?>">
                        <a href="https://limswarehouse.vidyagxp.com/stCondition" target="blank" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Storage Condition'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.storage_location*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.storage_location.*')); ?>">
                        <a href="https://limswarehouse.vidyagxp.com/storage-location" target="blank" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Storage Location'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.sample_login*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.sample_login.*')); ?>">
                        <a href="https://limswarehouse.vidyagxp.com/samplelogin" target="blank" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Sample Login'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.inventory_management*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.inventory_management.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.inventory_management')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Inventory Management'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.picking*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.picking.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.picking')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Picking'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.sampling*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.sampling.*')); ?>">
                        <a href="https://limswarehouse.vidyagxp.com/sampling/samplingConfiguration" target="blank"
                            class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Sampling'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.masteres*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.masters.*')); ?>">
                        <a href="https://limswarehouse.vidyagxp.com/Masters/Product" target="blank" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Masters'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.stability_managment*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.stability_managment.*')); ?>">
                        <a href="https://limswarehouse.vidyagxp.com/storageCondition1321" target="blank" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Stability Managment'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.ipqa*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.ipqa.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.ipqa')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('IPQA'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.analysis*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.analysis.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.analysis')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Analysis'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.packing*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.packing.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.packing')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Packing'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.despatch*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.despatch.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.despatch')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Despatch'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.weighing_dispensing*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.weighing_dispensing.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.weighing_dispensing')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Weighing and Dispensing'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.net_weight*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.net_weight.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.net_weight')); ?>" class="nav-link ">
                            <i class="menu-icon las la-dot-circle" style="font-size: 12px;"></i>
                            <span class="menu-title" style="font-size: 12px;"><?php echo app('translator')->get('Net Weight Calculator'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
                <?php $hasPermission = App\Models\Role::hasPermission(['admin.weighing_general_info*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
                    <li class="sidebar-menu-item <?php echo e(menuActive('admin.weighing_general_info.*')); ?>">
                        <a href="<?php echo e(route('admin.avl.weighing_general_info')); ?>" class="nav-link ">
                            <i class="menu-icon la la-warehouse"></i>
                            <span class="menu-title"><?php echo app('translator')->get('Callibration of Weighing Balance'); ?></span>
                        </a>
                    </li>
                <?php endif ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\warehouse_vidyagxp\resources\views/admin/partials/sidenav.blade.php ENDPATH**/ ?>