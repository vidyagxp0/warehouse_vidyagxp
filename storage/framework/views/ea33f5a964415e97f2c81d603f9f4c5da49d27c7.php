...
<head>
    ...
    ?>
    <?php if(file_exists($favicon) && is_file($favicon)): ?>
	<link rel="shortcut icon" href="<?php echo e(getImage($favicon)); ?>" type="image/x-icon">
    <?php else: ?>
	...
	<header class="py-3 border-bottom border-primary bg--dark">
		<div class="container">
			<div class="d-flex align-items-center justify-content-between header gap-3">
                <?php if(file_exists($logo) && is_file($logo)): ?>
				<img class="logo" src="<?php echo e(getImage($logo)); ?>" alt="ViserLab">
                <?php else: ?>
...
<?php /**PATH C:\laragon\www\warehouse\vendor\laramin\utility\src/Views/laramin_start.blade.php ENDPATH**/ ?>