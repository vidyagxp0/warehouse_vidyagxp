...
@section('panel')
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary cuModalBtn"
                                                    data-resource="{{ $brand }}" data-modal_title="@lang('Edit Brand')"
                                                    data-has_status="1">
                                                    <i class="la la-pencil"></i>@lang('Edit')
                                                </button>
                                                @can('admin.product.brand.delete')
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-danger @if ($brand->products_count) disabled @endif confirmationBtn"
                                                        data-question="@lang('Are you sure to delete this brand?')"
                                                        data-action="{{ route('admin.product.brand.delete', $brand->id) }}">
    ...
    <div class="modal fade" id="importModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">@lang('Import Brand')</h4>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="la la-times" aria-hidden="true"></i>
                    </button>
                </div>
                <form method="post" action="{{ route('admin.product.brand.import') }}" id="importForm"
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-1">
                                ...
                                <small>
                                    ...
                                    <a href="{{ asset('assets/files/sample/brand.csv') }}" title="@lang('Download csv file')"
...
@push('breadcrumb-plugins')
    ...
    @endcan
    @can('admin.product.brand.import')
