                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="subject" type="text" placeholder="@lang('Email subject')"
                                        required />
                                </div>
                            </div>
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="start_form" type="number"
                                                placeholder="@lang('Start form customer')" required />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="batch" type="number"
                                                    placeholder="@lang('How many customers')" required />
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text--danger dontCloseWarning text-center">@lang('Don\'t close or refresh the window until finished.')</h4>
                    ...
                    <div class="mt-3">
                        <p class="sentStatistics text-center mb-2">@lang('Email sent') <span class="startFrom">0</span>
                            @lang('to') <span class="sent">-</span> @lang('Customers')
                        </p>
    ...
    <script>
        (function($) {
            ...
            function postMail() {
                ...
                $.post("{{ route('admin.customer.notification.all.send') }}", {
                    "subject": subject,
                    "_token": _token,
                    "start": start,
                    "batch": perBatch,
