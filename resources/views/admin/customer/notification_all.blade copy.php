            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        ...
                        <p>@lang('Email sent') <span class="sent">0</span> @lang('Customers out of') {{ $customers }} @lang('customers')</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            function postMail(form, skip) {
                ...
                $.post("{{ route('admin.customer.notification.all.send') }}", {
                    ...
                    if (response.error) {
                        ...
                        var rest = {{ $customers }} - response.total_sent;
                        var sentPercent = response.total_sent / {{ $customers }} * 100;
                        if (sentPercent > 100) {
                            sentPercent = 100;
                        }
                        ...
                        if (rest == 0) {
                            setTimeout(() => {
                                ...
                                notify('success', 'Mail sent to all customers successfully')
                            }, 3000);
                            return false;
                        }
                        setTimeout(() => {
