...
@section('panel')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form action="{{ route('admin.setting.notification.sms.update') }}" method="POST">
                    @csrf
                    <div class="card-body">
...
@push('breadcrumb-plugins')
    <button type="button" data-bs-target="#testSMSModal" data-bs-toggle="modal"
        class="btn btn-outline--primary btn-sm"> <i class="las la-paper-plane"></i> @lang('Send Test SMS')
    </button>
@endpush
@push('style')
    <style>
