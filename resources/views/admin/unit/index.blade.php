            ...
            <div class="card b-radius--10">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary cuModalBtn"
                                                    data-resource="{{ $unit }}" data-modal_title="@lang('Update Unit')"
                                                    data-has_status="1">
                                                    <i class="la la-pencil"></i>@lang('Edit')
                                                </button>
                                                @can('admin.product.unit.delete')
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-danger @if ($unit->products_count) disabled @endif confirmationBtn"
                                                        data-question="@lang('Are you sure to delete this unit?')"
                                                        data-action="{{ route('admin.product.unit.delete', $unit->id) }}">
                ...
                @if ($units->hasPages())
                    <div class="card-footer d-flex justify-content-center py-4">
                        @php echo paginateLinks($units) @endphp
                    </div>
                @endif
            </div><!-- card end -->
        </div>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('admin.product.unit.import') }}" id="importForm"
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-1">
                                ...
                                <small>
                                    ...
                                    <a href="{{ asset('assets/files/sample/unit.csv') }}" title="@lang('Download csv file')"
